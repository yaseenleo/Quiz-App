...
import {jsques} from "./questions";

export default class jsquiz extends React.Component {
    state={
        timeout : false,
        score:0,
        scoreshow : false
    ...
    var jsques2 = jsques;
    jsques2=shuffle(jsques2);
  
    console.log(jsques2);
    
        const questions = jsques2.map((qs)=>
        <div>
            <p>{qs[1]}</p>
        ...
        return(
            ...
            <div> <h4 style={{"marginleft":"50px"}}>JS QUIZ</h4>
